          ...
          <div className="offer-col col">
            <div className="offer-info">
              <OfferInfo
                ...
                isFaved={isFaved}
                dislikeOffer={dislikeOffer}
                likeOffer={likeOffer}
              />
              <div className="divide-line-h"></div>
              <ImageRow
                className={`images ${isOfferOwner ? "grid-2" : "grid-1"}`}
                images={images}
                isOfferOwner={isOfferOwner}
                deleteImgFromOffer={deleteImgFromOffer}
